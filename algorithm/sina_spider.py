...
class SinaSpider(scrapy.Spider):
    ...
    def parse_article(self, response):
        ...
        loader.add_css('editor', 'p.show_author::text')
        loader.add_value('uri', response.url)
        loader.add_value('source', 'sina')
        loader.add_css('content', 'div.article::text')
        loader.add_css('published_at', 'a.source::text')
        loader.add_value('crawled_at', '')
        loader.add_css('time', 'span.date::text')
        loader.add_css('keyword', 'div.keywords::text')
